...
import { SOLUTIONS, FASTAPI_SOLUTIONS, REACT_SOLUTIONS, LINUX_SOLUTIONS, SCRAPING_SOLUTIONS, SECURITY_SOLUTIONS, ALG_SOLUTIONS, SQLAV_SOLUTIONS, JWT_SOLUTIONS, ESTAT_SOLUTIONS, GITAV_SOLUTIONS, ML_SOLUTIONS, getSolution } from '../solutions'
import { getInitialCode } from '../initial-codes'

const ALL_SOLUTIONS = { ...SOLUTIONS, ...FASTAPI_SOLUTIONS, ...REACT_SOLUTIONS, ...LINUX_SOLUTIONS, ...SCRAPING_SOLUTIONS, ...SECURITY_SOLUTIONS, ...ALG_SOLUTIONS, ...SQLAV_SOLUTIONS, ...JWT_SOLUTIONS, ...ESTAT_SOLUTIONS, ...GITAV_SOLUTIONS, ...ML_SOLUTIONS }
